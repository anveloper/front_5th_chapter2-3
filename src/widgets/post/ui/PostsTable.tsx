...
export const PostsTable = () => {
  const { loading, posts, setSelectedPost, searchQuery, selectedTag, setSelectedTag, updateURL, deletePost } =
    usePostContext();
  const { setShowPostDetailDialog, setShowUserModal, setShowEditDialog } = useDialogContext();
